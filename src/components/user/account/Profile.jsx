...
const Profile = () => {
    ...
    if (event.target.files && event.target.files[0]) {
      ...
      if (img) {
        ...
        try {
          ...
          try {
            await tokenaAxiosInstance.put(`/user/${currentUser._id}`, imgdata);
  ...
  const handleProfielUpdate = async (data) => {
    ...
    try {
      const response = await tokenaAxiosInstance.put(
            ...
            <div className="col-md-12">
              <div className="profile__img__wrapper shadow-sm">
                <div className="profile__img">
                  <img
                    src={currentUser.avater ? currentUser.avater : damiProfile}
                    alt="profile"
                  />
                  <label htmlFor="profileImg" className="imgLabel">
                    <AiFillCamera />
                  </label>
                </div>
                <input
                ...
                <form onSubmit={handleSubmit(handleProfielUpdate)}>
                  ...
                  <button
                    type="submit"
                    className="btn btn-flat btn-primary d-block mt-5 w-25 m-auto mb-3"
                  >
                    Update
                  </button>
                </form>
