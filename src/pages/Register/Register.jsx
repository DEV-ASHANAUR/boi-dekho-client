...
const Register = () => {
    ...
    const handleRegister = async (data) => {
        ...
        if (user) {
            // console.log(user);
            //after register on firebase then put the user info on the database
            ...
            <form action="" onSubmit={handleSubmit(handleRegister)}>
                <div className="login_wrapper">
                    ...
                    <div className="input__group">
                        ...
                        <input type="text" className='form-control mt-2' name='name' placeholder='Enter Name' {...register("username", {
                    ...
                    <div className="input__group">
                        ...
                        <input type="password" className='form-control mt-2' placeholder='Enter password' {...register("password", {
                        ...
                        {errors.password && <span className='error_message' role="alert">{errors.password?.message}</span>}
                    </div>
                    <div className="input__group">
                        <label>Confirm password</label>
                        <input type="password" className='form-control mt-2' placeholder='Confirm password' {...register('confirmPassword', {
                            required: true,
                            validate: (value) => value === password,
                        })} />
                        {errors.confirmPassword?.type === 'required' && (
                            <span className='error_message' role="alert" >Confirm password is required</span>
                        )}
                        {errors.confirmPassword?.type === 'validate' && (
                            <span className='error_message' role="alert" >Passwords must match</span>
                        )}
                    </div>
