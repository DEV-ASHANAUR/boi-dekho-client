                    ...
                    <div className="row justify-content-between">
                        <div className="col-lg-3 col-md-6 col-12">
                            <div className="social_icons">
                                ...
                                <div class="contact-area-footer mt-4">
                        ...
                        <div className="d-lg-none col-md-6 col-12">
                            <div className="footer-box">
                                <h5>We Accept</h5>
                                <p class="mt-3">Boi-kini - is a leading book shop in Bangladesh. We offer thousands of islamic, general and academic books at a discounted price. We provide good packaging with low shipping cost all over the Bangladesh.</p>
                                <img class="payment-footer img-fluid" src={img} alt="img" />
                            </div>
                        </div>
